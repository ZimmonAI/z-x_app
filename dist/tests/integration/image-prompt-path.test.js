...
test('image_prompt.prepare.v1 completes the fixture route and capacity path', async () => {
    const result = await executeFixturePath(validRequest('image_prompt.prepare.v1'), '00000000-0000-4000-8000-000000000001', {
        routes: new ZProviderFixtureV1(),
        capacity: new ZAccountFixtureV1(),
        autoHub: new AutoHubFixtureV1(),
        storage: new ZStorageFixtureV1(),
    });
    expect(result.promptText).toContain('sunrise');
});
//# sourceMappingURL=image-prompt-path.test.js.map