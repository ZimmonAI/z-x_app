...
test('fixture algorithm and TTL schema fail closed', () => {
    expect(() => loadConfig({ ZX_NODE_ENV: 'test', ZX_FIXTURE_AUTH_ALGORITHM: 'RS256' })).toThrow();
    expect(() => loadConfig({ ZX_NODE_ENV: 'test', ZX_FIXTURE_AUTH_TOKEN_TTL_SECONDS: '301' })).toThrow();
});
