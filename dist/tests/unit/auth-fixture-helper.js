...
import { calculateFixtureKeyId, FIXTURE_AUTH_ALGORITHM, FIXTURE_AUTH_AUDIENCE, FIXTURE_AUTH_ISSUER, } from '../../src/auth-fixture/constants.js';
import { loadConfig } from '../../src/config.js';
export function parseStatusCompatibleEnvironmentFile(contents) {
    const environment = {};
...
export function createFixtureAuthTestConfig() {
    ...
    if (!rawPublicJwk.x || !rawPublicJwk.y || !rawPrivateJwk.d)
        throw new Error('test key incomplete');
    ...
    return loadFixtureAuthRuntimeConfig(loadConfig({
        ZX_NODE_ENV: 'test',
...
//# sourceMappingURL=auth-fixture-helper.js.map