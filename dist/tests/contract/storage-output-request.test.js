...
test('validates old fixture requests without storage output', () => {
    expect(ExecutionRequestV1Schema.parse(validRequest()).contractVersion).toBe('zx.execution.v1');
});
...
test.each([
    ...
    expect(() => ExecutionRequestV1Schema.parse({
        ...validRequest('image.generate.v1'),
        requestedOutputType: 'image/png',
...
//# sourceMappingURL=storage-output-request.test.js.map