...
export class ZStorageFixtureV1 {
    ...
    async createOutputAuthorization(i, _s) { return { authorizationRef: `outauth_${i.executionId}`, uploadRef: 'upload_fixture_0001', expiresAt: new Date(60000).toISOString() }; }
