...
import { parseOutputReconciliationV1, parseReconcileOutputV1, } from '../../src/contracts/v1/dependencies.js';
import { SafeExecutionError } from '../../src/contracts/v1/error.js';
function stableStorageResult(input) {
...
export class ZStorageFixtureV1 {
    ...
    async createOutputAuthorization(input, _signal) {
    ...
    async completeOrIngestOutput(input, _signal) {
    ...
    async reconcileOutput(value, _signal) {
    ...
    async createReadGrant(input, _signal) {
        return {
