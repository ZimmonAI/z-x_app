...
export declare const TERMINAL_STATES: Set<"running" | "succeeded" | "failed" | "cancelled" | "reconciliation-required" | "accepted" | "timed-out" | "queued" | "resolving-route" | "waiting-capacity">;
