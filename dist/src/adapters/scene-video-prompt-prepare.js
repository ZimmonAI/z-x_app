...
export const sceneVideoPromptPrepareAdapter = {
    ...
    async execute({ request }) {
        ...
        const selectedImage = request.frozenInputResources.find((resource) => resource.kind.toLowerCase().includes('image'));
        if (!selectedImage) {
...
//# sourceMappingURL=scene-video-prompt-prepare.js.map