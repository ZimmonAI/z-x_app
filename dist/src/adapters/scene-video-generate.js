...
export const sceneVideoGenerateAdapter = {
    operation: 'scene_video.generate.v1',
    id: 'scene-video-generate-v1',
    version: '1.0.0',
    async execute(context) {
        requiredScalarString(context.request, 'prompt');
        const startImage = context.request.frozenInputResources.find((resource) => resource.kind.toLowerCase().includes('image'));
        if (!startImage) {
...
//# sourceMappingURL=scene-video-generate.js.map